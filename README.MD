Make sure your container active.
...
How it works: I set this up using Airflow to sync data every hour. It only grabs what is new or changed by looking at the updated_at timestamp.
